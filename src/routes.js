...
const TypeReceiptController = require("./controllers/TypeReceiptController");
...
routes.get("/cashReceipt", CashReceiptController.index);
routes.post("/cashReceipt", CashReceiptController.store);

routes.get("/typeReceipt", TypeReceiptController.index);
routes.post("/typeReceipt", TypeReceiptController.store);
